...
%save('Surf_Features','X_train_val','y_train_val','X_test_val','y_test_val','X_test','y_test')
...
network_structure = {[1024,10];[100,100,100,100,100,100,100,100,10];
    [528,256,128,10];[256,256,256,10];
    [128,256,528,526,128,10]; [256,528,256,10];
    [528,256,128,256,528,10]; [528,256,528,10];
